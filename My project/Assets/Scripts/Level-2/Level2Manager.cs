...
public class Level2Manager : MonoBehaviour
{
    ...
    public virtual void Start()
    {
        ...
        Hints.instance.ShowHint("To start the game press the button", 2);
    }
    ...
    void StepCompleted()
    {
        ...
        else
        {
            ...
            Hints.instance.ShowHint("Step completed. Press the button to start the next step", 2);
    ...
    void ResetGame()
    {
        ...
        Hints.instance.ShowHint("Wrong button pressed! Restarting", 2);
